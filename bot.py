...
def main():
    ...
    # The bot itself uses Telegram polling, so we expose a tiny health
    # endpoint in a background thread while polling runs normally.
    ...
    # Use polling. Do not configure a Telegram webhook on this service.
    app.run_polling()
